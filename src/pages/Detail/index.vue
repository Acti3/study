          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" @click="changeChecked(item,spuSaleAttr.spuSaleAttrValueList)" :class="{active:item.isChecked == 1}" v-for="item in spuSaleAttr.spuSaleAttrValueList" :key="item.id">{{item.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
import { mapGetters } from 'vuex'
  ...
  export default {
    ...
    mounted(){
        this.$store.dispatch('GoodsList',this.$route.params.skuid)
    },
    computed:{
